...
/*******************************************************************************
* Class Name:       Device
* File Name:        class.Device.php
* Generated:        Sunday, Jun 19, 2016 - 15:16:51 CEST
*  - for Table:     devices
...
class Device {
	...
	public function select($mID) { // SELECT Function
		...
		$sSQL = "SELECT * FROM devices WHERE id = $mID;";
	...
	public function insert() {
		...
		$sSQL = "INSERT INTO devices () VALUES ();";
		$oResult = $this->database->query($sSQL);
		$this->id = $this->database->lastinsertid;
	}
	
	function update($mID) {
		$sSQL = "UPDATE devices SET (id = '$this->id') WHERE id = $mID;";
		$oResult = $this->database->Query($sSQL);
	}
	
	public function delete($mID) {
		$sSQL = "DELETE FROM devices WHERE id = $mID;";
		$oResult = $this->database->Query($sSQL);
	}
