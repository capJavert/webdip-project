...
/*******************************************************************************
* Class Name:       Survey
* File Name:        class.Survey.php
* Generated:        Sunday, Jun 19, 2016 - 15:18:08 CEST
*  - for Table:     surveys
...
class Survey {
	...
	public function select($mID) { // SELECT Function
		...
		$sSQL = "SELECT * FROM surveys WHERE id = $mID;";
	...
	public function insert() {
		...
		$sSQL = "INSERT INTO surveys () VALUES ();";
		$oResult = $this->database->query($sSQL);
		$this->id = $this->database->lastinsertid;
	}
	
	function update($mID) {
		$sSQL = "UPDATE surveys SET (id = '$this->id') WHERE id = $mID;";
		$oResult = $this->database->Query($sSQL);
	}
	
	public function delete($mID) {
		$sSQL = "DELETE FROM surveys WHERE id = $mID;";
		$oResult = $this->database->Query($sSQL);
	}
